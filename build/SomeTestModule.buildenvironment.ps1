...
if ((Get-Variable 'BuildEnv' -ErrorAction:SilentlyContinue) -eq $null) {
    $Script:BuildEnv = New-Object -TypeName PSObject -Property @{
        ...
        ModuleTags = 'SomeTestModule,SomeTestModule,SomeTestModule,SomeTestModule,SomeTestModule,SomeTestModule,SomeTestModule,SomeTestModule,SomeTestModule,SomeTestModule,SomeTestModule,SomeTestModule,SomeTestModule,SomeTestModule' -split ','
    ...
    ########################################
    $PersistentBuildFile = join-path $PSScriptRoot "SomeTestModule.buildenvironment.json"
